...
| `src/pages/Session.tsx`、`src/session/`、`src/knowledge-canvas/`、`src/workspace/nav.ts` | 未选择时不再默认线性代数或 `defaultConceptId`；已选中仍页面发明 lesson/图 | canonical 初始回复 settle 后由 GraphSurgeon 创建并增量更新 |
