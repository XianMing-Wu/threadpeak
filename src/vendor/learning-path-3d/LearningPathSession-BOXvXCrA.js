...
}, Ne = (e) => e === "green" ? "绿色" : e === "brown" ? "知乎蓝" : "灰色", Pe = class {
	#e = [];
	#t = /* @__PURE__ */ new Map();
	#n;
	#r = !1;
...
var Re = new S("#fcfcfc"), ze = Math.max(4.6, t.bridgeSurfaceY + 2.8 + .15), Be = -.05, W = .92, G = 1.35, Ve = 30, K = 24, He = 1e-4, Ue = Object.freeze({
	...
	start: "\n    <svg viewBox=\"0 0 24 24\" xmlns=\"http://www.w3.org/2000/svg\">\n      <path d=\"M4 19 10 8l3 5 2-3 5 9H4zm6-3h4l-2-3-2 3z\"/>\n    </svg>\n  ",
	...
	goal: "\n    <svg viewBox=\"0 0 24 24\" xmlns=\"http://www.w3.org/2000/svg\">\n      <path d=\"M5 2h3v20H5V2zm4 2h11l-3 5 3 5H9V4z\"/>\n    </svg>\n  "
}, wt = {
	...St,
	...Ct
}, Tt = class {
	...
	constructor(e) {
		this.nodes = e.nodes, this.nodeById = new Map(this.nodes.map((e) => [e.id, e])), this.geometryRegistry = e.geometryRegistry, this.nodeBadgeIconById = e.nodeBadgeIconById ?? Object.freeze({}), this.currentIndex = e.initialNodeIndex, this.root.name = "learning-path", this.connectorRoot.name = "path-connectors", e.edges.forEach((e) => {
	...
	setNodeLearningState(e, t) {
		...
		let r = Object.freeze({
			kind: t.kind,
			status: t.status
		}), i = this.getToneForLearningState(r), a = this.getIconForLearningState(e, r);
...
//# sourceMappingURL=LearningPathSession-BOXvXCrA.js.map