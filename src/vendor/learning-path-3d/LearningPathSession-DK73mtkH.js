...
function H(t) {
	...
	return Object.freeze({
		...
		navigation: Object.freeze({
			phase: ue(o?.phase ?? r.navigationWorkflowPhase),
	...
	constructor(e) {
		...
		for (let t of e.nodes) {
			...
			let i = () => {
				...
				if (this.#r) return;
				let n = t.key;
				(n === "Enter" || n === " ") && (t.preventDefault(), t.stopPropagation(), e.onInspectRequested(r));
			};
...
function G(e) {
	...
	if (t <= n) {
		let t = (e.contentMin + e.contentMax) / 2 - r, i = Math.max(n * .18, 1), a = t - i, o = t + i;
		return Object.freeze({
			target: Math.min(o, Math.max(a, e.proposedTarget)),
			minimumTarget: a,
			maximumTarget: o,
			pannable: !0
		});
...
var Le = new S("#fcfcfc"), Re = Math.max(4.6, t.bridgeSurfaceY + 2.8 + .15), K = -.05, q = .92, ze = 1.35, J = 30, Be = 24, Ve = 1e-4, He = Object.freeze({
	...
	vector: "\n    <svg viewBox=\"0 0 24 24\" xmlns=\"http://www.w3.org/2000/svg\">\n      <path d=\"m4 17 11-11-3-3h8v8l-3-3L6 19l-2-2z\"/>\n    </svg>\n  ",
	transform: "\n    <svg viewBox=\"0 0 24 24\" xmlns=\"http://www.w3.org/2000/svg\">\n      <path d=\"M3 5h12V2l6 5-6 5V9H3V5zm18 10H9v-3l-6 5 6 5v-3h12v-4z\"/>\n    </svg>\n  ",
	structure: "\n    <svg viewBox=\"0 0 24 24\" xmlns=\"http://www.w3.org/2000/svg\">\n      <path d=\"M4 3h6v6H8v2h8V9h-2V3h6v6h-2v4h-5v2h2v6H9v-6h2v-2H6V9H4V3z\"/>\n    </svg>\n  ",
	kernel: "\n    <svg viewBox=\"0 0 24 24\" xmlns=\"http://www.w3.org/2000/svg\">\n      <path d=\"M3 5h5l4 5 4-5h5l-6 7 6 7h-5l-4-5-4 5H3l6-7-6-7z\"/>\n    </svg>\n  ",
	eigen: "\n    <svg viewBox=\"0 0 24 24\" xmlns=\"http://www.w3.org/2000/svg\">\n      <path d=\"M4 18 16 6h-4V3h9v9h-3V8L6 20l-2-2z\"/>\n    </svg>\n  ",
	data: "\n    <svg viewBox=\"0 0 24 24\" xmlns=\"http://www.w3.org/2000/svg\">\n      <path d=\"M3 19h18v2H3v-2zm2-7h3v5H5v-5zm6-5h3v10h-3V7zm6-4h3v14h-3V3z\"/>\n    </svg>\n  ",
	variance: "\n    <svg viewBox=\"0 0 24 24\" xmlns=\"http://www.w3.org/2000/svg\">\n      <path d=\"M4 16a2 2 0 1 1 0 4 2 2 0 0 1 0-4zm5-5a2 2 0 1 1 0 4 2 2 0 0 1 0-4zm5 2a2 2 0 1 1 0 4 2 2 0 0 1 0-4zm5-9a2 2 0 1 1 0 4 2 2 0 0 1 0-4zM3 13 18 3l2 3L5 16l-2-3z\"/>\n    </svg>\n  ",
	matrix: "\n    <svg viewBox=\"0 0 24 24\" xmlns=\"http://www.w3.org/2000/svg\">\n      <path d=\"M3 3h5v5H3V3zm7 0h5v5h-5V3zm7 0h4v5h-4V3zM3 10h5v5H3v-5zm7 0h5v5h-5v-5zm7 0h4v5h-4v-5zM3 17h5v4H3v-4zm7 0h5v4h-5v-4zm7 0h4v4h-4v-4z\"/>\n    </svg>\n  ",
	application: "\n    <svg viewBox=\"0 0 24 24\" xmlns=\"http://www.w3.org/2000/svg\">\n      <path d=\"M10 3h4v4h-4V3zM3 17h4v4H3v-4zm14 0h4v4h-4v-4zM5 8h3v3H5V8zm11 0h3v3h-3V8zm-5 3h2v4h-2v-4zM6 10l5 3-1 2-5-3 1-2zm12 0 1 2-5 3-1-2 5-3z\"/>\n    </svg>\n  ",
	...
	constructor(e) {
		this.nodes = e.nodes, this.nodeById = new Map(this.nodes.map((e) => [e.id, e])), this.geometryRegistry = e.geometryRegistry, this.lastLearningNodeId = e.lastLearningNodeId ?? null, this.nodeBadgeIconById = e.nodeBadgeIconById ?? Object.freeze({}), this.currentIndex = e.initialNodeIndex, this.root.name = "learning-path", this.connectorRoot.name = "path-connectors", e.edges.forEach((e) => {
	...
	setNodeLearningState(e, t) {
		...
		let r = Object.freeze({
			kind: t.kind,
			status: t.status
		}), i = this.getToneForLearningState(r, e), a = this.getIconForLearningState(e, r);
	...
	setLastLearningNode(e) {
		if (this.nodeViewById.get(e)?.learningState.kind !== "concept") return;
		let t = this.lastLearningNodeId;
		this.lastLearningNodeId = e;
		for (let n of [t, e]) {
			let e = n ? this.nodeViewById.get(n) : void 0;
			if (!e || !n) continue;
			let t = this.getToneForLearningState(e.learningState, n);
			e.tone = t, this.applyNodeTone(e, t), this.applyNodeBadge(e.badge, e.badge.icon, t);
		}
	}
	...
	getToneForLearningState(e, t) {
		return e.kind === "concept" && t === this.lastLearningNodeId ? "purple" : e.kind === "concept" ? e.status === "in-progress" || e.status === "completed" ? "brown" : "gray" : e.status === "completed" ? "green" : "gray";
	}
	getIconForLearningState(e, t) {
	...
	createNode(e, t) {
		...
		let a = this.createInitialNodeLearningState(e, t), s = this.getToneForLearningState(a, e.id);
		...
		let p = this.createNodeLearningBadge(this.getIconForLearningState(e.id, a), s);
	...
	disposed = !1;
	constructor(e) {
		this.coordinator = e.coordinator, this.recoveryBoundaryStore = new ie({
	...
	isNavigationIdle() {
		return se(this.requireOrchestrationActor().getSnapshot());
	}
	getSceneRuntimePort() {
	...
	completeRecoveryBoundaryIfStable() {
		...
		!se(t) || t.context.navigationPlan !== null || t.context.zoneRevealPlan !== null || t.context.zoneDismissPlan !== null || t.context.zoneTransitionActive || !t.context.characterVisualIdle || (e.transactionId ? this.recoveryBoundaryStore.complete(e.transactionId) : this.recoveryBoundaryStore.reset());
	}
	...
	driveIdleZoneRules() {
		...
		if (!(!se(e) || !e.context.characterVisualIdle)) {
			if (ce(e)) {
			...
			le(e) && this.requireOrchestrationActor().send({
...
function Yn(e) {
	...
	let ne = new Bt(f), L = new An(f, 13.25, ne), re = L.onNodeTraversed((t) => {
		...
		ce = s + Math.max(0, n);
		let c = () => {
			i !== se || a <= ue || (ue = a, ae.setPhase(e, t));
		}, l = Math.max(0, s - o);
		if (l <= 8) {
			c();
			return;
	...
	K = new Pe({
		...
		setHoveredNode: (e) => z.setHovered(e),
	...
	let Xe = new Te({
		...
		let e = L.getSnapshot(), n = R.getDebugSnapshot(), r = Y.getDebugSnapshot(), a = Y.getSnapshot().context, c = a.navigationPlan, u = t.getBoundingClientRect(), d = B.root.position.clone().project(I.camera), h = new Map(n.bridges.map((e) => [e.bridgeId, e])), g = [.../* @__PURE__ */ new Set([...h.keys(), ...z.getOverpassAnimationStates().flatMap((e) => e.edgeId === null ? [] : [e.edgeId])])].map((e) => z.getOverpassAnimationState(e)), b = new Map(g.flatMap((e) => e.edgeId ? [[e.edgeId, e]] : [])), x = new Set(e.remainingRouteEdgeIds), S = g.filter((e) => e.edgeId !== null && (e.desiredVisible || e.status !== "hidden" || h.has(e.edgeId))).map((e) => {
			...
			let r = z.getNodePresenceState(t.id), i = new y(t.position.x, t.surfaceY, t.position.z).project(I.camera), s = new y(t.position.x + .79, t.surfaceY, t.position.z).project(I.camera);
			return {
				id: t.id,
				index: n,
				color: z.getNodeColor(n),
		...
		return Object.freeze({
			...
			graph: {
				...
				authoredEdges: s.map((e) => ({
					...
					fromNodeId: e.fromNodeId,
					toNodeId: e.toNodeId,
					unlocked: R.isStraightEdgeUnlocked(e.id)
				}))
			},
			catalog: p,
			xstate: r,
			...
			revealGroups: n.zones.map((e) => {
				let t = m.find((t) => t.id === e.id)?.revealSequence.map((t) => {
					if (t.kind === "node") {
						let e = z.getNodePresenceState(t.nodeId);
						return {
							kind: t.kind,
							id: t.nodeId,
							desiredVisible: e.desiredVisible,
					...
					if (t.kind === "straight-edge") {
						let e = z.getStraightEdgePresenceState(t.edgeId);
						return {
							kind: t.kind,
							id: t.edgeId,
							desiredVisible: e.desiredVisible,
					...
					if (e.entryConnectorKind === "straight" && n) {
						let r = z.getStraightEdgePresenceState(n);
						return {
							kind: t.kind,
			...
			nodes: C,
			straightEdges: z.getStraightEdgePresenceStates().map((e) => ({
				...e,
				unlocked: R.isStraightEdgeUnlocked(e.id)
			})),
			bridges: S,
			...
			animation: B.getDebugState(),
			currentIndicator: z.getCurrentIndicatorState(),
			invariants: {
				...n.invariants,
...
//# sourceMappingURL=LearningPathSession-DK73mtkH.js.map