...
const media=`${import.meta.env.BASE_URL}media/project-demo-7c6edef79cfd`
...
export function DemoVideo(){
  ...
  return <main className="demo-video-page">
    ...
    <section className="demo-video-player" aria-label="项目介绍视频">
      <video ref={video} controls playsInline preload="none" poster={`${media}.jpg`} src={`${media}.mp4`} aria-label="项目介绍 · 完整故事版" onError={()=>setFailed(true)} onLoadedData={()=>setFailed(false)}>
        当前浏览器不支持视频播放。
      </video>
