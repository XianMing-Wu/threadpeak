...
| `.cursor/rules/50-frontend-runtime-ui.mdc` | React/TSX/CSS、RuntimeStore、页面、Chat 普通回答门、侧栏历史重开门、Settings identity/sources 门、Shell 账号身份门、Composer 附件/资料范围门、可访问性和浏览器状态 |
