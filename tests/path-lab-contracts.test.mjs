...
test('泛化 3D adapter 对新文档执行 dispose 后 remount，旧入口仍兼容', () => {
  ...
  assert.match(path3d, /\[documentId, instanceIdPrefix, nodeBadgeIconById\]/)
  assert.match(path3d, /onContextualCardActionRef/)
  assert.doesNotMatch(path3d, /onContextualCardAction, onResourceNavigate\]/)
