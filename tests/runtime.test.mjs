...
test('问题会话支持普通回答、路线澄清与相关图文三种入口',()=>{assert.match(chat,/DefaultAnswer/);assert.match(chat,/ChatRoutePanel/);assert.match(chat,/VisualAnswer/);assert.match(chat,/setTimeout/);assert.match(chat,/followUp/)})
