...
test('问题会话支持普通回答、路线澄清与相关图文三种 Mock 体验',()=>{assert.match(chat,/DefaultAnswer/);assert.match(chat,/RouteClarification/);assert.match(chat,/VisualAnswer/);assert.match(chat,/setTimeout/);assert.match(chat,/followUp/)})
