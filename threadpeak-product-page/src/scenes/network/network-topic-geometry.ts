...
import topic0 from "../../../assets/lettering/network-topic-0.svg?raw";
import topic1 from "../../../assets/lettering/network-topic-1.svg?raw";
import topic2 from "../../../assets/lettering/network-topic-2.svg?raw";
import topic3 from "../../../assets/lettering/network-topic-3.svg?raw";
...
export function topicGeometry(index: number) {
    ...
    const scale = Math.min(20 / size.y, 178 / size.x);
